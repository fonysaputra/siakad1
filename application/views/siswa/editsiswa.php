<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open_multipart('siswa/editsiswa', 'role="form" class="form-horizontal"');
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?php echo $siswa['nim'] ?>"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "13" readonly="" placeholder="MASUKAN NIM" id="form-field-1" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
           ...
           <input type="hidden" name="rombel"  value="<?php echo $siswa['id_rombel'] ?>">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
